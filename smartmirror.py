...
def on_message(client, obj, msg):
    ...
    if(msg.topic == "Focus"):
        print("Event come: " + str(msg.payload))
        global getFocusFromMqtt 
        getFocusFromMqtt = str(msg.payload)
        # print(event_name_mqtt)
...
icon_lookup = {
    ...
    'hail': "/home/pi/SmartMirror/assests/Hail.png"  # hail
}
...
class NewsHeadline(Frame):
    def __init__(self, parent, event_name=""):
        ...
        image = Image.open("/home/pi/SmartMirror/assets/Newspaper.png")
...
class Calendar(Frame):
    def __init__(self, parent, *args, **kwargs):
        Frame.__init__(self, parent, bg='black')
        self.title = 'Made By Gyanendra Sahu and Abhishek Vishwakarma \n Guided By: Dr. Siddhartha Choubey \n SSGI, BHILAI'
        #self.guided = 'Guided By: Dr. Siddhartha Choubey'
        self.calendarLbl = Label(self, text=self.title, font=('Britannic Bold', 15), fg="white", bg="black")
...
class CalendarEvent(Frame):
    ...
    def __init__(self, parent, event_name=""):
        Frame.__init__(self, parent, bg='black')
        self.eventName = event_name
        self.eventNameLbl = Label(self, text=self.eventName, font=('Helvetica', 15), fg="white", bg="black")
        self.eventNameLbl.pack(side=TOP, anchor=E)
class ClgName(Frame):
    def __init__(self, parent, *args, **kwargs):
        Frame.__init__(self, parent, bg='black')
        self.title = 'SSGI,BHILAI'
        self.guidedLbl = Label(self, text=self.title, font=('Britannic Bold', 15), fg="white", bg="black")
        
        self.guidedLbl.pack(side=TOP, anchor=E)


class FocusToday(Frame):
    def __init__(self, parent, *args, **kwargs):
        Frame.__init__(self, parent, bg='black')
        self.title = 'Focus Today'
        self.titleLbl = Label(self, text=self.title, font=('Britannic Bold', 15), fg="white", bg="black")
        self.titleLbl.pack(side=TOP)
        self.focus = ''
        self.focusLbl = Label(self, text=self.focus, font=('Helvetica', 13), fg="white", bg="black")
        self.focusLbl.pack(side=TOP)
        self.getConst()

    def getConst(self):
        global getFocusFromMqtt
        
        self.focusLbl.config(text=getFocusFromMqtt)
        self.focusLbl.after(200, self.getConst)
...
class FullscreenWindow:
    ...
    def __init__(self):
        ...
        self.clock.pack(side=RIGHT, anchor=N, padx=0, pady=10)
        # weather
        self.weather = Weather(self.topFrame)
        self.weather.pack(side=LEFT, anchor=N, padx=0, pady=10)        
        ...
        self.calender.pack(side = TOP, anchor=S, padx=0, pady=10)
	#self.clgName = ClgName(self.bottomFrame)
        #self.clgName.pack(side = RIGHT, anchor=S, padx=0, pady=0)

        self.focusGet = FocusToday(self.topFrame)
        self.focusGet.pack(side = RIGHT, anchor = E, padx=0, pady=0)
